...
![Preuzimanje putem CRAN-a](CRAN.png){width=600px}
</div>
<br>

<div class="text-align: center;">
![Preuzimanje putem posit-a](Install.png){height=500px}
</div>
<br>
...
```{r, prompt=TRUE, echo=FALSE}
library(readr)
Starwars <- read.csv("https://raw.githubusercontent.com/kakoste/Uvod_u_R_i_R_Studio/blob/main/starwars_fiksni.csv")
```
